import{j as r}from"./jsx-runtime-D_zvdyIk.js";import"./iframe-19Tryois.js";import"./preload-helper-D9Z9MdNV.js";const e=({children:m,variant:g="primary",size:p="md",disabled:l=!1,...y})=>{const h="font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200",B={primary:"bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500",secondary:"bg-gray-100 text-gray-700 hover:bg-gray-200 focus:ring-gray-500 border border-gray-300",success:"bg-green-600 text-white hover:bg-green-700 focus:ring-green-500",danger:"bg-red-600 text-white hover:bg-red-700 focus:ring-red-500"},v={sm:"px-3 py-1.5 text-sm",md:"px-4 py-2 text-sm",lg:"px-6 py-3 text-base"},S=l?"opacity-50 cursor-not-allowed":"";return r.jsx("button",{className:`${h} ${B[g]} ${v[p]} ${S}`,disabled:l,...y,children:m})},D={title:"Components/Button",component:e,parameters:{layout:"centered"},argTypes:{variant:{control:{type:"select"},options:["primary","secondary","success","danger"]},size:{control:{type:"select"},options:["sm","md","lg"]},disabled:{control:{type:"boolean"}}}},s={args:{children:"Button"}},a={args:{children:"Primary Button",variant:"primary"}},n={args:{children:"Secondary Button",variant:"secondary"}},t={args:{children:"Success Button",variant:"success"}},o={args:{children:"Danger Button",variant:"danger"}},c={args:{children:"Small Button",size:"sm"}},i={args:{children:"Large Button",size:"lg"}},d={args:{children:"Disabled Button",disabled:!0}},u={render:()=>r.jsxs("div",{className:"space-x-4",children:[r.jsx(e,{variant:"primary",children:"Primary"}),r.jsx(e,{variant:"secondary",children:"Secondary"}),r.jsx(e,{variant:"success",children:"Success"}),r.jsx(e,{variant:"danger",children:"Danger"})]})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    children: 'Button'
  }
